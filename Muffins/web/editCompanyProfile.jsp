                ...
                <div class="row">
                    <form action="editCompanyServlet" method="post" enctype="multipart/form-data">
                        <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group required">
                                    <label>Differentiation of Product</label>
                                    <textarea class="form-control" rows="3" name="product_differentiation" placeholder="Enter Differentiation of Product Here.." required><%= company.getProductDiff()%></textarea>
                                </div>
                                <div class="col-sm-6 form-group required">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group required">
                                    ...
                                    <textarea class="form-control" rows="3" name="traction" placeholder="Enter Traction Here.." required><%= company.getTraction()%></textarea>
                                </div>
                                <div class="col-sm-6 form-group required">
