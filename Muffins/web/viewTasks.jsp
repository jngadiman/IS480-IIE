                    ...
                    <tbody>
                        <%
                                        for (Task t : tasks) {
                                            ...
                                            out.println("<td><a href='displayTaskServlet?taskID=" + t.getTaskId() + "&stageID=" + stage + "&company=" + user.getCompanyid() + " 'class ='btn btn-success btn-xs center-block'>Edit</a></td>");
